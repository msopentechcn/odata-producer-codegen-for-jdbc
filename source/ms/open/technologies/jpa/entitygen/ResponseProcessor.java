...
import ms.open.technologies.jpa.entitygen.infos.ResponseInfo;
...
public class ResponseProcessor {
	...
	private Map<String,String> getOptionMap() {
		...
		for(int i=0;allTables!=null&&i<allTables.size();i++){
			...
			if(!JPA_ENTITY__EXPOSE_TABLENAME.toLowerCase().equals(tableName.toLowerCase())){
	...
	protected void setResponseInfoSuccessfully(){
		String RESPONSEMESSAGE_OK = "Entity created successfully!Please restart the service ["+request.getServletContext().getContextPath()+"] now!";
