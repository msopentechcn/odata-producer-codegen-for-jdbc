...
import olingo.apache.auto.entity.metadata.processor.MetadataToInfoProcessor;
 ...
 * @author Bruce Li
 */
public class AutoEntityProcessor {
	...
	public void creatModel(PathInfo pathInfo) throws Exception {
		...
		ModelInfo modelInfo = new DatabaesInfoToEntityClassInfoProcessor()
	...
	private EntityClassInfo setEntityClassInfo(PathInfo pathInfo)
		...
		InputStream input = AutoEntityProcessor.class
